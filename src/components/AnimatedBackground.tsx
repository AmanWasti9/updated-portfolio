...
export const AnimatedBackground: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const resizeCanvas = () => {
      ...
      // Adjust particle count based on screen size (reduce for mobile)
      if (window.innerWidth < 768) {
        particleCount = 20; // Reduce particles for mobile
      } else {
        particleCount = 50; // Increase particles for larger screens
      }
    };
